...
const tileGap = 2;
var snakeX = tileCount/2; var snakeY = tileCount/2;
var appleX = Math.floor(Math.random()*tileCount); var appleY = Math.floor(Math.random()*tileCount);
var trail = [];
const startingTailLength = 5;
var tailLength = startingTailLength;
var score = tailLength-5; var highscore = score;
